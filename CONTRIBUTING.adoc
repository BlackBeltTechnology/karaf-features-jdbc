# Contributing to karaf-features-jdbc

## Installing the correct versions of Java, Maven and necessary dependencies

karaf-features-jdbc is currently built on top of JDK 11.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/karaf-features-jdbc/issues/new/choose[issue form].
